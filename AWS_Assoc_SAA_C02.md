SR- [Introduction](#introduction)
    - [Exam Content Breakdown:](#exam-content-breakdown)
    - [Recommended Reading:](#recommended-reading)
  - [Identity Access Management (IAM)](#identity-access-management-iam)
    - [IAM Simplified:](#iam-simplified)
    - [IAM Entities:](#iam-entities)
    - [IAM Key Details:](#iam-key-details)
    - [Amazon Resource Names (ARN) (Update 8-9/3/2020)](#amazon-resource-names-arn-update-8-932020)
    - [Priority Levels in IAM:](#priority-levels-in-iam)
  - [Simple Storage Service (S3) OLDER](#simple-storage-service-s3-older)
    - [S3 Simplified:](#s3-simplified)
    - [S3 Key Details:](#s3-key-details)
    - [S3 Storage Classes:](#s3-storage-classes)
    - [S3 Encryption:](#s3-encryption)
    - [S3 Versioning (Updated 9/2020):](#s3-versioning-updated-92020)
    - [S3 Lifecycle Management:](#s3-lifecycle-management)
    - [S3 Cross Region Replication:](#s3-cross-region-replication)
    - [S3 Transfer Acceleration:](#s3-transfer-acceleration)
    - [S3 Event Notications:](#s3-event-notications)
    - [S3 and ElasticSearch:](#s3-and-elasticsearch)
    - [Maximizing S3 Read/Write Performance:](#maximizing-s3-readwrite-performance)
    - [S3 Server Access Logging:](#s3-server-access-logging)
    - [S3 URL's (9/19/20)](#s3-urls-91920)
    - [S3 Multipart Upload:](#s3-multipart-upload)
    - [S3 URL's (9/19/20)](#s3-urls-91920-1)
    - [S3 Pre-signed URLs:](#s3-pre-signed-urls)
    - [S3 Select:](#s3-select)
    - [S3 REST API (Added 9/24/2020)](#s3-rest-api-added-9242020)
  - [CloudFront](#cloudfront)
    - [CloudFront Simplified:](#cloudfront-simplified)
    - [CloudFront Key Details:](#cloudfront-key-details)
    - [CloudFront Signed URLs and Signed Cookies:](#cloudfront-signed-urls-and-signed-cookies)
  - [Snowball](#snowball)
    - [Snowball Simplified:](#snowball-simplified)
    - [Snowball Key Details:](#snowball-key-details)
    - [Snowball Edge and Snowmobile:](#snowball-edge-and-snowmobile)
  - [Storage Gateway](#storage-gateway)
    - [Storage Gateway Simplified (Updated 9/2020):](#storage-gateway-simplified-updated-92020)
    - [Storage Gateway Key Details:](#storage-gateway-key-details)
    - [Stored Volumes vs. Cached Volumes:](#stored-volumes-vs-cached-volumes)
  - [Elastic Compute Cloud (EC2)](#elastic-compute-cloud-ec2)
    - [EC2 Simplified:](#ec2-simplified)
    - [EC2 Key Details:](#ec2-key-details)
    - [EC2 AMI's](#ec2-amis)
    - [EC2 Instance Pricing:](#ec2-instance-pricing)
    - [Standard Reserved vs. Convertible Reserved vs. Scheduled Reserved:](#standard-reserved-vs-convertible-reserved-vs-scheduled-reserved)
  ...
  - [Elastic Block Store (EBS)](#elastic-block-store-ebs)
    - [EBS Simplified:](#ebs-simplified)
    - [EBS Key Details:](#ebs-key-details)
    - [SSD vs. HDD:](#ssd-vs-hdd)
    - [EBS Snapshots:](#ebs-snapshots)
    - [EBS Root Device Storage:](#ebs-root-device-storage)
    - [EBS Encryption:](#ebs-encryption)
  - [Elastic Network Interfaces (ENI)](#elastic-network-interfaces-eni)
    - [ENI Simplified:](#eni-simplified)
    - [ENI Key Details:](#eni-key-details)
  - [Security Groups](#security-groups)
    - [Security Groups Simplified:](#security-groups-simplified)
    - [Security Groups Key Details:](#security-groups-key-details)
  - [Web Application Firewall (WAF)](#web-application-firewall-waf)
    - [WAF Simplified:](#waf-simplified)
    - [WAF Key Details:](#waf-key-details)
    - [WAF Protection Capabilities:](#waf-protection-capabilities)
  - [CloudWatch](#cloudwatch)
    - [CloudWatch Simplified:](#cloudwatch-simplified)
    - [CloudWatch Key Details:](#cloudwatch-key-details)
  ...
  - [CloudTrail](#cloudtrail)
    - [CloudTrail Simplified:](#cloudtrail-simplified)
    - [CloudTrail Key Details:](#cloudtrail-key-details)
  - [Elastic File System (EFS)](#elastic-file-system-efs)
    - [EFS Simplified:](#efs-simplified)
    - [EFS Key Details:](#efs-key-details)
  - [Amazon FSx for Windows](#amazon-fsx-for-windows)
    - [Amazon FSx for Windows Simplified:](#amazon-fsx-for-windows-simplified)
    - [Amazon FSx for Windows Key Details:](#amazon-fsx-for-windows-key-details)
  - [Amazon FSx for Lustre](#amazon-fsx-for-lustre)
    - [Amazon FSx for Lustre Simplified:](#amazon-fsx-for-lustre-simplified)
    - [Amazon FSx for Lustre Key Details:](#amazon-fsx-for-lustre-key-details)
  - [Relational Database Service (RDS)](#relational-database-service-rds)
    - [RDS Simplified:](#rds-simplified)
    - [RDS Key Details:](#rds-key-details)
  ...
  - [Aurora](#aurora)
    - [Aurora Simplified:](#aurora-simplified)
    - [Aurora Key Details:](#aurora-key-details)
    - [Aurora Serverless:](#aurora-serverless)
    - [Aurora Cluster Endpoints:](#aurora-cluster-endpoints)
    - [Aurora Reader Endpoints:](#aurora-reader-endpoints)
  - [DynamoDB](#dynamodb)
    - [DynamoDB Simplified:](#dynamodb-simplified)
    - [DynamoDB Key Details:](#dynamodb-key-details)
    - [DynamoDB Accelerator (DAX):](#dynamodb-accelerator-dax)
    - [DynamoDB Streams:](#dynamodb-streams)
    - [DynamoDB Global Tables](#dynamodb-global-tables)
  - [Redshift](#redshift)
    - [Redshift Simplified:](#redshift-simplified)
    - [Redshift Key Details:](#redshift-key-details)
  - [Redshift Spectrum:](#redshift-spectrum)
  - [Redshift Enhanced VPC Routing:](#redshift-enhanced-vpc-routing)
  - [ElastiCache](#elasticache)
    - [ElastiCache Simplified:](#elasticache-simplified)
    - [ElastiCache Key Details:](#elasticache-key-details)
  - [Route53](#route53)
    - [Route53 Simplified:](#route53-simplified)
    - [Route53 Key Details:](#route53-key-details)
    - [Route53 Routing Policies:](#route53-routing-policies)
  - [Elastic Load Balancers (ELB)](#elastic-load-balancers-elb)
    - [ELB Simplified:](#elb-simplified)
    - [ELB Key Details:](#elb-key-details)
    - [ELB General:](#elb-general)
    - [ELB Advanced Features:](#elb-advanced-features)
    - [ELB Cross Zone Load Balancing:](#elb-cross-zone-load-balancing)
    - [ELB Security:](#elb-security)
  - [Auto Scaling](#auto-scaling)
    - [Auto Scaling Simplified:](#auto-scaling-simplified)
    - [Auto Scaling Key Details:](#auto-scaling-key-details)
    - [Auto Scaling Default Termination Policy:](#auto-scaling-default-termination-policy)
  - [Auto Scaling Cooldown Period:](#auto-scaling-cooldown-period)
  - [Virtual Private Cloud (VPC)](#virtual-private-cloud-vpc)
    - [VPC Simplified:](#vpc-simplified)
    - [VPC Key Details (Updated 9/4/2020):](#vpc-key-details-updated-942020)
    - [VPC Subnets (Updated 9/4/2020):](#vpc-subnets-updated-942020)
    ...
    - [Virtual Private Networks (VPNs): (Updated 9/27/20)](#virtual-private-networks-vpns-updated-92720)
  ...
  - [Simple Queuing Service (SQS) (Updated 9/28/2)](#simple-queuing-service-sqs-updated-9282)
    - [SQS Simplified (Updated 9/24/2020)](#sqs-simplified-updated-9242020)
    - [SQS Key Details:](#sqs-key-details)
    - [SQS Polling:](#sqs-polling)
  - [Simple Workflow Service (SWF) (Updated 9/28/2020)](#simple-workflow-service-swf-updated-9282020)
    - [SWF Simplified:](#swf-simplified)
    - [SWF Key Details (Updated 9/28/2020)](#swf-key-details-updated-9282020)
  - [Simple Notification Service (SNS)](#simple-notification-service-sns)
    - [SNS Simplified:](#sns-simplified)
    - [SNS Key Details (Updated 9/28/20)](#sns-key-details-updated-92820)
    - [SNS vs. SQS](#sns-vs-sqs)
  - [Kinesis (Updated 9/27/2020)](#kinesis-updated-9272020)
    - [Kinesis Simplified:](#kinesis-simplified)
    - [Kinesis Key Details:](#kinesis-key-details)
  - [Lambda](#lambda)
    - [Lambda Simplified:](#lambda-simplified)
    - [Lambda Key Details:](#lambda-key-details)
  ...
  - [CloudFormation](#cloudformation)
    - [CloudFormation Simplified:](#cloudformation-simplified)
    - [CloudFormation Key Details:](#cloudformation-key-details)
  - [ElasticBeanstalk](#elasticbeanstalk)
    - [ElasticBeanstalk Simplified:](#elasticbeanstalk-simplified)
    - [ElasticBeanstalk Key Details:](#elasticbeanstalk-key-details)
  - [AWS Organizations](#aws-organizations)
    - [AWS Organizations Simplified:](#aws-organizations-simplified)
    - [AWS Organizations Key Details:](#aws-organizations-key-details)
- [Web Identity Federation (Added 9/28/2020)](#web-identity-federation-added-9282020)
  - [Cognotio User Pools (Added 9/28/2020)](#cognotio-user-pools-added-9282020)
- [Event Processing Patterns (Added 9/28/2020)](#event-processing-patterns-added-9282020)
  ...
  - [Miscellaneous](#miscellaneous)
    - [What is the Amazon Cognito? (Legacy text)](#what-is-the-amazon-cognito-legacy-text)
    - [What is AWS Resource Access Manager?](#what-is-aws-resource-access-manager)
    - [What is Athena?](#what-is-athena)
    - [What is AWS Macie?](#what-is-aws-macie)
    - [What is AWS KMS?](#what-is-aws-kms)
    - [What is AWS Secrets Manager?](#what-is-aws-secrets-manager)
    - [What is AWS STS?](#what-is-aws-sts)
    - [What is OpsWorks?](#what-is-opsworks)
    - [What is Elastic Transcoder?](#what-is-elastic-transcoder)
    - [What is AWS Directory Service?](#what-is-aws-directory-service)
    - [What is IoT Core?](#what-is-iot-core)
    - [What is AWS WorkSpaces?](#what-is-aws-workspaces)
    - [What is AWS Fargate?](#what-is-aws-fargate)
    - [What is Amazon Elastic Container Service?](#what-is-amazon-elastic-container-service)
    - [What is Amazon Elastic Kubernetes Service?](#what-is-amazon-elastic-kubernetes-service)
    - [What does pilot light mean?](#what-does-pilot-light-mean)
    - [What are Blue-Green deployments?](#what-are-blue-green-deployments)
    - [What is Amazon Data Lifecycle Manager?](#what-is-amazon-data-lifecycle-manager)
    - [What is Route Origin Authorization?](#what-is-route-origin-authorization)
...
- [AWS SAA-C02 Study Guide](#aws-saa-c02-study-guide)
  ...
  - [Identity Access Management (IAM)](#identity-access-management-iam-1)
    ...
    - [Amazon Resource Names (ARN) (Update 9/3/2020)](#amazon-resource-names-arn-update-932020)
  ...
  - [Storage Gateway](#storage-gateway-1)
    - [Storage Gateway Simplified:](#storage-gateway-simplified)
...
## Simple Storage Service (S3) OLDER
...
### Storage Gateway Simplified (Updated 9/2020):
...
### EBS Key Details (Updated 9/29/20)
...
## Elastic Network Interfaces (ENI) (Updated 0/29/2020)
...
### ENI Key Details (Updated 0/29/2020)
...
### Security Groups Key Details (Updated 9/29/2020)
...
## Simple Queuing Service (SQS) (Updated 9/28/2)
...
## Simple Workflow Service (SWF) (Updated 9/28/2020)
...
### SWF Key Details (Updated 9/28/2020)
...
### SNS Key Details (Updated 9/28/20)
...
# Web Identity Federation (Added 9/28/2020)
...
## Cognotio User Pools (Added 9/28/2020)
...
# Event Processing Patterns (Added 9/28/2020)
...
## Publisher / Subscriber (Added 9/28/2020)
...
## Dead Letter Queue (Added 9/28/2020
...
### Amazon Resource Names (ARN) (Update 9/3/2020)
The underlying identifier is called the Amazon Resource Name, or ARN. ARN's uniquely identify resources.
- Format: arn:partition:service:region:account_id:
- Partition: Separates infrastructure, 'aws' or 'aws-cn' (China)
- Service: EC2, S3, rds.
...
- The data consistency model for S3 ensures `eventual read consistency` for PUTS and DELETES of already existing objects. This is because the change takes a little time to propagate across the entire Amazon network. Applies to all regions (9/24/2020)
- Because of the eventual consistency model when updating existing objects in S3, those updates might not be immediately reflected. As object updates are made to the same key, an older version of the object might be provided back to the user when the next read request is made. 
- Amazon guarantees 99.999999999% (or 11 9s) durability for all S3 storage classes except its Reduced Redundancy Storage class.
- HTTP verbs include PUT, DELETE, HEAD, GET. (Covered in a tutorial: https://docs.amazonaws.cn/en_us/apigateway/latest/developerguide/integrating-api-with-aws-services-s3.html)
...
- S3 comes with the following main features:
  ...
  5.) MFA deletes to prevent accidental or malicious removal of content (best way to protect against accidental delete)
